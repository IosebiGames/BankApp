...
User can Restart their account, change password of it or Clear/Invest Hypothethical money from account.<br>

**Please Note that:** following application isn't real Bank App, it just demonstrates hypothethical banking operations.

## How it is made: 
Of course, Bank App is made by using Java Swing and AWT (Abstract Window Toolkit). But comfortable Look & Feel comes from small library, FlatLaf.
Swing is in-built framework from JRE System Library and is used for GUI-development. Click sound is managed by Java Sound API (Also called as Java Sound).

## My opinion on it: 
Honestly, Bank App is totally normal yet kind of strange Java project, because it is not as fancy as RecipeManager just to say, but it still has some functionality too, just like any other Java Apps.
...
## Limitation: 
 Statistics stay as 0 regardless of service connection or activity, if it wasn't modified from source code. (Let's see if this will change one day.)
